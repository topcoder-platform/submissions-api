...
prepare(function (done) {
  ...
  nock(/.com/)
    ...
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'reviewType')
    .query(true)
    .reply(200, testData.testReviewTypesES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'submission')
    .query(true)
    .reply(200, testData.testSubmissionsES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'review')
    .query(true)
    .reply(200, testData.testReviewsES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'reviewSummation')
    .query(true)
    .reply(200, testData.testReviewSummationsES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'nonExistent')
    .query(true)
    .reply(200, { hits: { total: 0, hits: [] } })
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'c56a4180-65aa-42ec-a945-5fd21dec0501')
    .query(true)
    .reply(200, testData.testReviewTypeES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'a12a4180-65aa-42ec-a945-5fd21dec0501')
    .query(true)
    .reply(200, testData.testSubmissionES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'd24d4180-65aa-42ec-a945-5fd21dec0502')
    .query(true)
    .reply(200, testData.testReviewES)
    .post(`/${config.osConfig.OS_INDEX}/${config.osConfig.OS_TYPE}/_search`, 'e45e4180-65aa-42ec-a945-5fd21dec1504')
    .query(true)

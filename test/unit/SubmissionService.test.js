  ...
  describe('POST /submissions', () => {
    ...
    it('Creating submission with file upload should get succeeded', (done) => {
      chai.request(app)
        ...
        .end((err, res) => {
          res.should.have.status(200)
          res.body.should.have.keys(Object.keys(_.extend({ fileType: 'zip', submissionPhaseId: 733196, submittedDate: '2018-05-20T07:00:30.123Z' }, _.omit(testSubmission.Item, ['legacySubmissionId', 'review', 'reviewSummation']))))
          ...
          res.body.submissionPhaseId.should.be.eql('90ddb27a-cc49-454c-8367-354011eeba73')
          done()
        })
    })
    ...
    it('Creating submission with url passing should get succeeded', (done) => {
      chai.request(app)
        ...
        .end((err, res) => {
          res.should.have.status(200)
          res.body.should.have.keys(Object.keys(_.extend({ fileType: 'zip', submissionPhaseId: 733196, submittedDate: '2018-05-20T07:00:30.123Z' }, _.omit(testSubmission.Item, ['review', 'reviewSummation']))))
          res.body.id.should.not.be.eql(null)
          res.body.challengeId.should.be.eql(testSubmission.Item.challengeId)
          res.body.type.should.be.eql(testSubmission.Item.type)
          res.body.url.should.be.eql(testSubmission.Item.url)
  ...
  describe('PUT /submissions/:submissionId', () => {
    ...
    it('Updating submission with Admin token should get succeeded', (done) => {
      chai.request(app)
        ...
        .end((err, res) => {
          res.should.have.status(200)
          res.body.should.have.keys(Object.keys(_.extend({ submissionPhaseId: 733196 }, _.omit(testSubmission.Item, ['review', 'reviewSummation', 'submittedDate']))))
          res.body.id.should.not.be.eql(null)
          res.body.challengeId.should.be.eql(testSubmission.Item.challengeId)
          res.body.type.should.be.eql(testSubmission.Item.type)
          res.body.url.should.be.eql(testSubmission.Item.url)
